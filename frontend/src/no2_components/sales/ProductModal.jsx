        ...
        >
            <ModalInner>
                ...
                <Form
                    ...
                    size='large'
                >
                    {/* name="product_name" -> name="productName" */}
                    ...
                    <Form.Item label="단가" name="price" rules={[{ required: true, message: "단가를 입력하세요." }]}>
                        <InputNumber placeholder='예: 40000' style={{ width: "100%" }} />
                    </Form.Item>
                    {/* name="sale_price" -> name="salePrice" */}
                    <Form.Item label="판매가" name="salePrice" rules={[{ required: true, message: "판매가를 입력하세요." }]}>
                        <InputNumber placeholder='예: 80000' style={{ width: "100%" }} />
                    </Form.Item>
                    {/* name="category_code" -> name="categoryCode" */}
                    <Form.Item label="카테고리 코드" name="categoryCode" rules={[{ required: true, message: "카테고리 코드를 선택하세요." }]}>
